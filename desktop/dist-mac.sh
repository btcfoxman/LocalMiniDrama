...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版（Intel）：OverseasDrama-x.x.x-mac-x64.dmg"
echo "  完整版（ARM）  ：OverseasDrama-x.x.x-mac-arm64.dmg"
echo "  纯净版（Intel）：OverseasDrama-Lite-x.x.x-mac-x64.dmg"
echo "  纯净版（ARM）  ：OverseasDrama-Lite-x.x.x-mac-arm64.dmg"
echo ""
