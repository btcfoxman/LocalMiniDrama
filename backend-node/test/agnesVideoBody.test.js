...
describe('resolveVideoProtocol', () => {
  it('detects an Agnes-compatible endpoint without referencing an out-of-scope provider variable', () => {
    assert.equal(resolveVideoProtocol({
      provider: 'openai',
